								...
								<div class="aa-product-view-slider">
									<div id="demo-1" class="simpleLens-gallery-container">
										<div class="simpleLens-container">
											<div>
												<a
													data-lens-image="${pageContext.request.contextPath}/view/client/assets/images/products/img-test/${detail_product.image}"
													class="simpleLens-lens-image"><img
													src="${pageContext.request.contextPath}/view/client/assets/images/products/img-test/${detail_product.image}"
							...
							<div class="col-md-7 col-sm-7 col-xs-12">
								<div class="aa-product-view-content">
									...
									<div class="aa-price-block">
										<c:choose>
											<c:when test="${detail_product.discount == 0.0}">
												<span class="aa-product-price"><fmt:parseNumber type="number" value ="${detail_product.price}"></fmt:parseNumber> VNĐ</span>
											
											</c:when>
											<c:otherwise>
												<c:forEach items="${productlist1}" var="product1">
													<c:if test="${product1.id == detail_product.id}">
														<span class="aa-product-price"><strong><fmt:parseNumber type="number" value ="${product1.price}"></fmt:parseNumber>
																VNĐ</strong></span>
														<span class="aa-product-price"><del><fmt:parseNumber type="number" value ="${detail_product.price}"></fmt:parseNumber>
																VNĐ</del></span>
													</c:if>
												</c:forEach>
											</c:otherwise>
										...
										<figcaption>
											...
											<c:choose>
												<c:when test="${product.discount == 0.0}">
													<span class="aa-product-price"><fmt:parseNumber type="number" value ="${product.price}"></fmt:parseNumber> <u>VNĐ</u></span>
													
												</c:when>
												<c:otherwise>
													<c:forEach items="${productlist1}" var="product1">
														<c:if test="${product1.id == product.id}">
															<span class="aa-product-price"><fmt:parseNumber type="number" value ="${product1.price}"></fmt:parseNumber>
																VNĐ</span>
