  			...
  			<div class="card">
                ...
                <form action="${pageContext.request.contextPath}/admin/admin/add" method="post"> 
                  ...
                  <div class="form-group"> 
                    ...
                    <input type="text" class="form-control text-dark" id="input-1" placeholder="Username"  name="admin-username" required> 
                  </div> 
                  <div class="form-group"> 
                    <label class="text-dark" for="input-1">Password</label> 
                    <input type="password" class="form-control text-dark" id="myinput" placeholder="Password" name="admin-password" required>
                 ...
                 <div class="form-group"> 
                    <label class="text-dark" for="input-1">Tên Admin</label> 
                    <input type="text" class="form-control text-dark" id="input-1" placeholder="Tên Admin" name="admin-name" required> 
                  </div>	
                  <br>
